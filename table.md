...
* column	  : store_seq(pk), question_seq(fk), store_name, menu_name, review, file_path, count
*
...
insert into store_info (question_seq, store_code, store_name, store_address, menu_name, review, file_path, count_store, franchise_yn)
...
* column	  : title_seq(pk), question_seq(fk), title_code, title_name, file_path
*
*/
drop table title_info ;
...
insert into title_info (question_seq, title_code, title_name, file_path)
values(6, 'TT001', '역시 근본', '이미지 아직 없음');
insert into title_info (question_seq, title_code, title_name, file_path)
values(7, 'TT002', '페퍼로니♥ 파인애플 피자 극혐', '이미지 아직 없음');
insert into title_info (question_seq, title_code, title_name, file_path)
values(8, 'TT003', '맛도리', '이미지 아직 없음');
insert into title_info (question_seq, title_code, title_name, file_path)
values(9, 'TT004', '이 구역 맵찔이', '이미지 아직 없음');
insert into title_info (question_seq, title_code, title_name, file_path)
values(10, 'TT005', '돌고 돌아 다시 엽떡', '이미지 아직 없음');
...
* column	  : loading_seq(pk), phrases, file_path
*
* result is random(5)
*
...
insert into loading_for_analyze (phrases, file_path, use_yn)
...
* column	  : combination_seq(pk), file_path
*
* result is random(5)
*
*/
...
insert into utteok_combination (file_path, file_original_name, file_masking_name)
values('conbination_file_path 1', 'no original name 1', 'no masking name 1');
insert into utteok_combination (file_path, file_original_name, file_masking_name)
values('conbination_file_path 2', 'no original name 2', 'no masking name 2');
insert into utteok_combination (file_path, file_original_name, file_masking_name)
values('conbination_file_path 3', 'no original name 3', 'no masking name 3');
...
* column	  : seq(pk), file_path, content
*
*/
...
insert into review_for_store (content, file_path, create_date)
values('재료들의 맛조화가 절묘하게 좋았다', 'review_file_path 1', SYSDATE());
insert into review_for_store (content, file_path, create_date)
values('맛있어요', 'review_file_path 1', SYSDATE());
insert into review_for_store (content, file_path, create_date)
values('시금치 베이글 처음 먹어봤는데, 생각보다 맛있고 제 스타일이었어요 !!', 'review_file_path 2', SYSDATE());
